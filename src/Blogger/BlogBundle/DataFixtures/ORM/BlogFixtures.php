...
class BlogFixtures implements FixtureInterface
{
    ...
    {
        $blog1 = new Blog();
        $blog1->setTitle('la creation de lOlympique Lyonnais');
        ...
        $blog1->setImage('tolisso.jpeg');
        $blog1->setAuthor('tass');
